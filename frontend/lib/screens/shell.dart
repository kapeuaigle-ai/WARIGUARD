    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: NavigationBar(
          ...
          indicatorColor: Wg.teal.withValues(alpha: 0.14),
          ...
          destinations: const [
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.dashboard_rounded, color: Wg.teal),
              label: 'Accueil',
            ),
            NavigationDestination(
              icon: Icon(Icons.sms_outlined, color: Wg.textDim),
              selectedIcon: Icon(Icons.sms_rounded, color: Wg.teal),
              label: 'Text Shield',
            ),
            NavigationDestination(
              icon: Icon(Icons.link_outlined, color: Wg.textDim),
              selectedIcon: Icon(Icons.link_rounded, color: Wg.teal),
              label: 'Link Shield',
            ),
            NavigationDestination(
              icon: Icon(Icons.lock_outline_rounded, color: Wg.textDim),
              selectedIcon: Icon(Icons.lock_rounded, color: Wg.teal),
              label: 'Sécurité',
            ),
          ],
        ),
